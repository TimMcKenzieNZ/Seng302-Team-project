...
public class CLIToSQLCommandSanitizer {
  ...
  private static final List<String> SQLBlackList = new ArrayList<String>(Arrays.asList("drop table", "delete", "alter table", "create table", "insert", "update", "truncate table"));
